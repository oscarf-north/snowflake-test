create or replace TABLE PRD_HOSPENG_REPORTING.DATAADMIN.SPROC_LISTS (
	...
	EXTERNAL_ACCESS_INTEGRATIONS VARCHAR(16777216),
	SECRETS VARCHAR(16777216),
	RUNTIME_VERSION VARCHAR(16777216),
	PACKAGES VARCHAR(16777216),
	INSTALLED_PACKAGES VARCHAR(16777216)
);
